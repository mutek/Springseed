...
(function() {
  var $, Dropbox, S, Splitter, autogrow, buffer, db, fs, gui, handlebars, http, jonoeditor, marked, modal, mt, net, path, rangyinputs, util;
  ...
  jonoeditor = (function() {
    ...
    function jonoeditor(el, timer) {
      ...
      this.el.find("textarea").autogrow().on("change keyup", function() {
        ...
        var endPos, myValue, scrollTop, startPos;
        if (e.keyCode === 9) {
          myValue = "    ";
  ...
  window.noted = {
    ...
    init: function() {
      var copyFile, copycallback, defaults, doneamount, _base, _base1, _ref, _ref1,
        _this = this;
      ...
      return (_ref1 = (_base1 = window.localStorage).cursor) != null ? _ref1 : _base1.cursor = "";
    },
    ...
    initUI: function() {
      ...
      window.noted.window.on('maximize', function() {
        return window.noted.isMaximized = true;
      });
      window.noted.window.on('unmaximize', function() {
        return window.noted.isMaximized = false;
      });
      mt.bind('ctrl+w', function(e) {
        return window.noted.window.close();
      });
      mt.bind('ctrl+q', function(e) {
        return window.noted.window.close();
      });
      window.noted.load.notebooks();
      ...
      $('body').on("click", "#maximize", function() {
        if (window.noted.isMaximized) {
          return window.noted.window.unmaximize();
        } else {
